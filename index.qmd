...
The next meeting is scheduled for __January 23, 2025__, at the University of Essen, room [R12 R06 A48](#location). We’ll be discussing the paper _Generalized additive models for location, scale
and shape_ (<a href = "paper/Rigby-Generalized_additive_models_for_location_scale_and_shape.pdf" download="Rigby-Generalized_additive_models_for_location_scale_and_shape.pdf">Rigby and Stasinopoulos, 2005</a>). To start, __Simon Hirsch__ will give a brief 20-minute presentation to introduce the topic and set the stage for discussion.
